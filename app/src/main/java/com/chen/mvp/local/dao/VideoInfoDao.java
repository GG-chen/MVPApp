...
public class VideoInfoDao extends AbstractDao<VideoInfo, String> {
    ...
    public static class Properties {
        ...
        public final static Property TotalSize = new Property(12, long.class, "totalSize", false, "TOTAL_SIZE");
        public final static Property LoadedSize = new Property(13, long.class, "loadedSize", false, "LOADED_SIZE");
        public final static Property DownloadStatus = new Property(14, int.class, "downloadStatus", false, "DOWNLOAD_STATUS");
        public final static Property DownloadSpeed = new Property(15, long.class, "downloadSpeed", false, "DOWNLOAD_SPEED");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"VIDEO_INFO\" (" + //
                ...
                "\"TOTAL_SIZE\" INTEGER NOT NULL ," + // 12: totalSize
                "\"LOADED_SIZE\" INTEGER NOT NULL ," + // 13: loadedSize
                "\"DOWNLOAD_STATUS\" INTEGER NOT NULL ," + // 14: downloadStatus
                "\"DOWNLOAD_SPEED\" INTEGER NOT NULL ," + // 15: downloadSpeed
    ...
    protected final void bindValues(DatabaseStatement stmt, VideoInfo entity) {
        ...
        stmt.bindLong(13, entity.getTotalSize());
        stmt.bindLong(14, entity.getLoadedSize());
        stmt.bindLong(15, entity.getDownloadStatus());
        stmt.bindLong(16, entity.getDownloadSpeed());
    ...
    public VideoInfo readEntity(Cursor cursor, int offset) {
        VideoInfo entity = new VideoInfo( //
            ...
            cursor.getLong(offset + 12), // totalSize
            cursor.getLong(offset + 13), // loadedSize
            cursor.getInt(offset + 14), // downloadStatus
            cursor.getLong(offset + 15), // downloadSpeed
    ...
    public void readEntity(Cursor cursor, VideoInfo entity, int offset) {
        ...
        entity.setTotalSize(cursor.getLong(offset + 12));
        entity.setLoadedSize(cursor.getLong(offset + 13));
        entity.setDownloadStatus(cursor.getInt(offset + 14));
        entity.setDownloadSpeed(cursor.getLong(offset + 15));
